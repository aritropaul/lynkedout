    ...
    return (
        <main className="flex flex-col items-start justify-start p-24">
            ...
            <div className="flex flex-row items-center justify-center">
                <div className="mr-2 text-sm font-normal"> {props.job.title} @ {props.job.company}</div>
            ...
            <div className="px-0 mt-4 w-[320px] md:w-[480px] lg:w-[600px] leading-[150%] text-xs font-normal text-neutral-700">
                {props.job.desc}
            </div>
